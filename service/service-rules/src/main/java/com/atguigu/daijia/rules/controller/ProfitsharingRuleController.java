...
public class ProfitsharingRuleController {
    ...
    public Result<ProfitsharingRuleResponseVo> calculateOrderProfitsharingFee(@RequestBody @Validated ProfitsharingRuleRequestForm profitsharingRuleRequestForm) {
