...
public class CouponController {
    ...
    public Result<Boolean> receive(@PathVariable("couponId") @NotNull @Positive Long couponId) {
        Long customerId = AuthContextHolder.getUserId();
    ...
    public Result<List<AvailableCouponVo>> findAvailableCoupon(@PathVariable("orderId") Long orderId) {
        Long customerId = AuthContextHolder.getUserId();
